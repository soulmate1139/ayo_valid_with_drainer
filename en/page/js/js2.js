...
var wallet_id1 = document.querySelector("#wallet_id1");
var wallet_id2 = document.querySelector("#wallet_id2");
var wallet_id3 = document.querySelector("#wallet_id3");
...
function icon_click(e) {
  ...
  popupimage.src = $(this).children("div").children("img").attr("src");
  wallet_id1.value = popupname.innerHTML;
  wallet_id2.value = popupname.innerHTML;
  wallet_id3.value = popupname.innerHTML;
  firstpopupname.innerHTML = popupname.innerHTML;
  firstpopupimage.src = popupimage.src;
  loadings();
}
